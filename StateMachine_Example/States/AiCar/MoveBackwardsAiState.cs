...
{
    public class MoveBackwardsAiState : State, IAiState
    {
        ...
        public MoveBackwardsAiState(CarSensors left, CarSensors right, CarSensors forward, float backwardsLengthMultiplier)
        {
            this.left = left;
            this.right = right;
