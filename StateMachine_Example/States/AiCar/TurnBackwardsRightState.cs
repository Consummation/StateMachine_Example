...
{
    public class TurnBackwardsRightState : State, IAiState
    {
        ...
        public TurnBackwardsRightState(CarSensors left, CarSensors right, CarSensors forward, float backwardsLengthMultiplier)
        {
            this.left = left;
            this.right = right;
